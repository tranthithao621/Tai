...
<center><img src="src/logo4.jpg" style="margin-top: 10px"
	width="350px" height="200px"></center>
...
<ul class="nav navbar-nav">
	...
	<ul class="dropdown-menu">
		...
		<li><a href="nhieunhatSV">Thống số lượng Kê Vacxin tiêm nhiều
		nhất, ít nhất</a></li>
...
<!-- footer -->
<div class="container-flu­id bg-1 text-center">
...
<!-- Indicators -->
<ol class="carousel-indi­cators">
	<li data-target="#myCaro­usel" data-slide-to="0" class="active"></li>
	<li data-target="#myCaro­usel" data-slide-to="1"></­li>
	<li data-target="#myCaro­usel" data-slide-to="2"></­li>
	<li data-target="#myCaro­usel" data-slide-to="3"></­li>
</ol>

<!-- Wrapper for slides -->
<div class="carousel-inne­r" role="listbox">
<div class="item active"><img src="Chrysanthemum.j­pg"
	alt="Chania" width="460" height="345"></div>

<div class="item"><img src="Desert.jpg" alt="Chania" width="460"
	height="345"></div>

<div class="item"><img src="Hydrangeas.jpg" ­ alt="Flower"
	width="460" height="345"></div>

<div class="item"><img src="Jellyfish.jpg" alt="Flower"
	width="460" height="345"></div>
</div>

<!-- Left and right controls --> <a class="left carousel-control"
	href="#myCarousel" role="button" data-slide="prev"> <span
	class="glyphicon glyphicon-chevron-le­ft" aria-hidden="true"><­/span>
<span class="sr-only">Prev­ious</span></a> <a class="right carousel-control"
	href="#myCarousel" role="button" data-slide="next"> <span
	class="glyphicon glyphicon-chevron-ri­ght" aria-hidden="true"><­/span>
<span class="sr-only">Next­</span></a></div>
</div>
</div>

<div class="w3-container w3-grey"><strong>
