...
<body>
   ...
   <center>
	...
	<tr>
		<td colspan="9"><h2 align="center"><span style="color: green" >Danh Sách Vacxin hết hạn  </span></h2></td>
	...
	<center>
		<%
			if(total_page > 0){
				%>
						<ul class="pagination">
						<li><a href="hethanSV?page=1<%= request.getParameter("s") !=null?"&s="+request.getParameter("s"):"" %>">  << </a></li>
							<%
								for(int i = 0;i<total_page;i++){
									%>
										
									    <li class="<%= curent_page == (i + 1)?"active":"" %>" ><a  href="hethanSV?page=<%=i+1 %><%= request.getParameter("s") !=null?"&s="+request.getParameter("s"):"" %>"><%= i + 1 %></a></li>
									    
									<%
								}
							%>
							<li><a href="hethanSV?page=<%=total_page %><%= request.getParameter("s") !=null?"&s="+request.getParameter("s"):"" %>">  >> </a></li>
						</ul>
				<%
			}
		%>
